      ...
      <div class="card-body">
        <form class="forms-sample" action="{{ route('BO.kamar.update_kamar') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="number" name="no_kamar" class="form-control" value="{{ $kamar->no_kamar }}" placeholder="Nomor Kamar" readonly>
            </div>
            <div class="form-group">
              <label>Lokasi</label>
            ...
            <div class="form-group">
              ...
              <input type="number" name="harga" class="form-control" value="{{ $kamar->harga }}" id="exampleInputEmail3" placeholder="Email" readonly>
            </div>
            <div class="form-group">
