...
@section('content')
    <div>
        <div class="btn-wrapper">
            <a href="#" class="btn btn-primary text-white me-0" data-toggle="modal" data-target="#update_harga_kamar"><i
                    class="icon-download"></i> Set Harga Kamar</a>
                            ...
                            <tbody>
                                @forelse($kamar as $kmr)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('BO.kamar.edit_kamar', $kmr->id) }}"
    ...
    <div class="modal fade" id="update_harga_kamar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="harga" name="harga"
                                placeholder="Masukkan Harga Kamar Baru" required>
                        </div>
                    </div>
